    ...
    <div class="authincation h-100">
        <div class="container h-100">
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-lg-5 col-sm-8 pl-xs-5 pr-xs-5">
                    <div class="authincation-content btn-round">
                        <div class="row no-gutters">
                            <div class="col-xl-12 pl-5 pr-5 pl-xs-0 pr-xs-0">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="{{ url('/') }}"><img src="{{ asset('images/logo.png') }}" style="width:180px" alt=""></a>
									</div>
                                    <h4 class="text-center mb-4" style="color:#393472">Login to your admin account</h4>
                                    <form action="#">
                                        {{ csrf_field() }}
