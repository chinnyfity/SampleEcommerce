...
class CartController extends Controller
{
    ...
    function cart(){
        $data['id_url'] = "";
        $data['page_name'] = "cart";
        $data['page_title'] = "My Cart - Buy your beautiful arts";
        $cartItems = \Cart::getContent();
        $data['subtotal'] = \Cart::getTotal();

        if(count($cartItems) <= 0) return Redirect::to('/');
        
        $data['locatn'] = "Lekki, Lagos";
    ...
    function checkout(){
        ...
        $data['page_title'] = "Checkout - Buy your beautiful arts";
        $cartItems = \Cart::getContent();
